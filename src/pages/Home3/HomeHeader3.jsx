...
import logo from "../../assets/home3/home3logo"
      ...
      <div className="collapse navbar-collapse" id="navbarSupportedContent">
        <ul className="navbar-nav m-auto text-center">
          <li className="nav-item dropdown">
            <a className="nav-link active dropdown-toggle d-flex align-items-center gap-2 justify-content-center" href="index.html" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
        ...
        <form className="d-flex gap-4 authBtn">
          ...
          <button className="signup_button " style={{border: '1px solid #fff'}}>
            <a href="signup.html" className type="submit"><img src="/assets/home1/user-circle.png" alt />
              Create Account</a>
          </button>
        </form>
      </div>
